...
DemoApp::addPageHeaderTo(Ui::layout(), 'List', $subtitles);
DemoApp::addLineInfo(Ui::layout(), 'List styles');
...
DemoApp::addLineInfo(Ui::layout(), 'Using custom template.');
...
DemoApp::addLineInfo(Ui::layout(), 'Using callback rendering.');
