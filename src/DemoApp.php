    ...
    private static function getNavigationGroup(string $baseUrl = '/'): array
    {
        return [
            ...
            new Group([
                'name' => 'Basics',
                'icon' => 'bi bi-box',
                'url' => $baseUrl . 'basic/view/',
                'items' => [
                    new Item(['name' => 'View', 'url' => $baseUrl . 'basic/view/']),
                    new Item(['name' => 'Button/Link', 'url' => $baseUrl . 'basic/button/']),
                    new Item(['name' => 'Header', 'url' => $baseUrl . 'basic/header/']),
                    new Item(['name' => 'Message', 'url' => $baseUrl . 'basic/message/']),
                    new Item(['name' => 'Tag', 'url' => $baseUrl . 'basic/tag/']),
                    new Item(['name' => 'Grid', 'url' => $baseUrl . 'basic/grid-layout/']),
                    new Item(['name' => 'List', 'url' => $baseUrl . 'basic/list/']),
                    new Item(['name' => 'Breadcrumb', 'url' => $baseUrl . 'basic/breadcrumb/']),
                ],
            ]),
            new Group([
                'name' => 'Form',
            ...
            new Group([
                ...
                'url' => $baseUrl . 'collection/table/',
                'items' => [
                    new Item(['name' => 'Table', 'url' => $baseUrl . 'collection/table/']),
                    new Item(['name' => 'Table w. Atk Model', 'url' => $baseUrl . 'collection/table-as-crud/']),
                ],
            ]),
            new Group([
                'name' => 'Javascript',
                'icon' => 'bi bi-code-slash',
                'url' => $baseUrl . 'javascript/js/',
                'items' => [
                    new Item(['name' => 'jQuery Integration', 'url' => $baseUrl . 'javascript/js/']),
                ],
            ]),
            new Group([
                'name' => 'Interactive',
                'icon' => 'bi bi-chat-left',
                'url' => $baseUrl . 'interactive/virtual/',
                'items' => [
                    new Item(['name' => 'Modal', 'url' => $baseUrl . 'interactive/modal/']),
                    new Item(['name' => 'Toast', 'url' => $baseUrl . 'interactive/toast/']),
                    new Item(['name' => 'Virtual Page', 'url' => $baseUrl . 'interactive/virtual/']),
                    new Item(['name' => 'Server Side Event', 'url' => $baseUrl . 'interactive/sse/']),
                    new Item(['name' => 'Console', 'url' => $baseUrl . 'interactive/console/']),
                ],
            ]),
        ];
    }
